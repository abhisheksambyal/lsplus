...
np.save(f'{numpy_dir}/test_testlabels_{args.method.lower()}.npy', testLabels)
np.save(f'{numpy_dir}/test_logits_{args.method.lower()}.npy', t1_logits)
np.save(f'{numpy_dir}/test_probabilities_{args.method.lower()}.npy', t1)
