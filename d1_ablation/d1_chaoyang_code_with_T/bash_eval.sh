...
cde; conda activate tf1; python baseline_fl.py -epochs 200 -test 1 -model resnet50 -bestmodelpath resnet50/1/fl_best_model.hdf5 -gpu 0 -csvfilename resnet50/metrics.csv;
...
# # Resnet34
# # python tsne_baseline.py -epochs 200 -test 1 -bestmodelpath resnet34/1/vanilla_best_model.hdf5 -gpu 0 -csvfilename resnet34/metrics.csv; 
# # python tsne_baseline.py -epochs 200 -test 1 -bestmodelpath resnet34/1/fl_best_model.hdf5 -gpu 0 -csvfilename resnet34/metrics.csv;
# # python tsne_visualization.py -epochs 200 -test 1 -bestmodelpath resnet34/1 -m LS -gpu 0 -csvfilename resnet34/metrics.csv; 
# # python tsne_visualization.py -epochs 200 -test 1 -bestmodelpath resnet34/1 -m ours_alpha05 -gpu 0 -csvfilename resnet34/metrics.csv;

# # python tsne_baseline.py -epochs 200 -test 1 -bestmodelpath resnet34/2/vanilla_best_model.hdf5 -gpu 0 -csvfilename resnet34/metrics.csv; 
# # python tsne_baseline.py -epochs 200 -test 1 -bestmodelpath resnet34/2/fl_best_model.hdf5 -gpu 0 -csvfilename resnet34/metrics.csv;
# # python tsne_visualization.py -epochs 200 -test 1 -bestmodelpath resnet34/2 -m LS -gpu 0 -csvfilename resnet34/metrics.csv; 
# # python tsne_visualization.py -epochs 200 -test 1 -bestmodelpath resnet34/2 -m ours_alpha05 -gpu 0 -csvfilename resnet34/metrics.csv;

# # python tsne_baseline.py -epochs 200 -test 1 -bestmodelpath resnet34/3/vanilla_best_model.hdf5 -gpu 0 -csvfilename resnet34/metrics.csv; 
# # python tsne_baseline.py -epochs 200 -test 1 -bestmodelpath resnet34/3/fl_best_model.hdf5 -gpu 0 -csvfilename resnet34/metrics.csv;
# # python tsne_visualization.py -epochs 200 -test 1 -bestmodelpath resnet34/3 -m LS -gpu 0 -csvfilename resnet34/metrics.csv; 
# # python tsne_visualization.py -epochs 200 -test 1 -bestmodelpath resnet34/3 -m ours_alpha05 -gpu 0 -csvfilename resnet34/metrics.csv;
